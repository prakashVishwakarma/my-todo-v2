            ...
            <div className={styles.card}>
                ...
                <div className={styles.bottom}>
                    ...
                    <div className={styles.socialButtonsContainer}>
                        ...
                        <button className={`${styles.socialButton} ${styles.socialButton2}`}>
                        ...
                        <button className={`${styles.socialButton} ${styles.socialButton3}`}>
                    ...
                    <div className={styles.viewMore}>
                        ...
                        <svg className={styles.svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"></path></svg>
                    </div>
                </div>
            </div>
        </div>
